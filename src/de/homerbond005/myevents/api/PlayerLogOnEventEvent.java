...
/**
 * @author HomerBond005
 * This event is called when a player logs on to a MyEvents event
...
public class PlayerLogOnEventEvent extends MyEventsPlayerEvent{
	 ...
	 * @param player The player that is logging on to an event
	 */
	public PlayerLogOnEventEvent(EventStorage event, long timestamp, Player player){
